...
- Three directions in active development:
  ...
  - **Direction D — Organic / Botanical Monogram** — fluid, nature-inspired letterform construction. Letters woven through or entwined with organic botanical elements (fine-line botanicals, plant stems, tendrils, seedheads). Flowing stroke weight variation, natural curvature — neither geometric nor calligraphic in the traditional sense. Reference: [Figma node 24-203](https://www.figma.com/design/rvJZnrqjpW5zkOM9u80xZl/ALT.-COSMETICS-%7C-Identity-and-packaging?node-id=24-203&t=1dVS95InZLuGVRa1-1). Pairs naturally with the chrome finish — organic softness against industrial material. Debossing territory.
- Legibility vs abstraction is NOT a direction — it is an independent axis applying to all four. Each direction could produce a readable A-L-T mark or a dissolved abstract form. Decision deferred to concept presentation with Anh.
